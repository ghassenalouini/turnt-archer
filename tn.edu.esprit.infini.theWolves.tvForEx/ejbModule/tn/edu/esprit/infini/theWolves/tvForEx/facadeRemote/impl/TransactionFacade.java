...
public class TransactionFacade implements TransactionFacadeRemote {
	...
	/*
	 * @Override public boolean addTransaction(Customer customer, Currency
	 * currency, String typeOfTransaction, int amount, float cotation) { boolean
	 * b = false; try { Transaction transaction = new
	 * Transaction(typeOfTransaction, amount, customer, currency, cotation);
	 * entityManager.persist(transaction); b = true;
	 * 
	 * } catch (Exception e) { System.err.println("error add transaction ...");
	 * } return b; }
	 */
	/*
	 * @Override public boolean addCrossTransaction(Transaction) {
	 * 
	 ...
	 * entityManager.persist(transactionCross); b = true;
	 * 
	 * } catch (Exception e) {
	 * System.err.println("error addCross Transaction ..."); } return b; }
	 * 
	 * @Override public boolean createOffer(Bank bank, Currency currency, float
	 * cotation) { boolean b = false; try { Transaction transaction = new
	 * Transaction(cotation, bank, currency);
	 * entityManager.persist(transaction); b = true;
	 * 
	 * } catch (Exception e) { System.err.println("error create offer ..."); }
	 * return b; }
	 */
