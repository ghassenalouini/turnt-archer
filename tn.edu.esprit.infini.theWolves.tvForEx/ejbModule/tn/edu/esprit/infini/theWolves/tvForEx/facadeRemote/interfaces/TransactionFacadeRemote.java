...
public interface TransactionFacadeRemote {
	...
	/*
	 * // ME public boolean addTransaction(Customer customer, Currency currency,
	 * String typeOfTransaction, int amount, float cotation);
	 * 
	 * public boolean addCrossTransaction(Customer customer, Customer
	 * customerBid, Currency currency, Currency currencyCross, String type, int
	 * amount, float cotation, float cotationBase);
	 * 
